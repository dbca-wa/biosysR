...
#> Variables: 7
#> $ id           <chr> "126", "127"
#> $ record_count <int> 1848, 1848
#> $ data_package <list> [["tabular-data-package", "BioSys Config", "sby_...
#> $ name         <chr> "Seagrass", "test"
#> $ type         <chr> "observation", "generic"
#> $ description  <chr> "An example excerpt of benthic community composit...
#> $ project_id   <int> 6, 6
```
