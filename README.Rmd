...
[![Coverage Status](https://coveralls.io/repos/github/parksandwildlife/biosysR/badge.svg?branch=master)](https://coveralls.io/github/parksandwildlife/biosysR?branch=master)
...
The main purpose of `biosysR` is to facilitate reading, parsing and using 
...
Send us your ideas and requests as [issues](https://github.com/parksandwildlife/biosysr/issues) 
